import{_ as e,c as r,o as t,ag as a}from"./chunks/framework.DyIQiYOb.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/BaGuWen/write.md","filePath":"docs/BaGuWen/write.md"}'),i={name:"docs/BaGuWen/write.md"};function o(l,n,s,c,u,m){return t(),r("div",null,n[0]||(n[0]=[a(`<h2 id="实现一个new操作符" tabindex="-1">实现一个new操作符 <a class="header-anchor" href="#实现一个new操作符" aria-label="Permalink to &quot;实现一个new操作符&quot;">​</a></h2><details><summary>实现一个new操作符</summary><pre><code>
      /** 手写 new 操作符
      * 用法：创建一个实例化对象
      * 思路：
