...
| width | 设置layout viewport 的宽度, 为一个正整数 |
| height | 设置layout viewport 的高度, 为一个正整数 |
| :------ | :-------: |
...
外接式媒体查询
```html
<link rel="stylesheet" media="screen and (max-width: 768px) and (min-width: 320px)" href="./css/index.css">
